...
@categories_api.route('/categories/new', methods=['POST'])
def create_category():
    return 'Create category'

# dict will be converted to JSON automatically
# for other ones use jsonify() or use community extensions
@categories_api.route('/categories/<uuid:category_id>', methods=['GET'])
def get_category(category_id):
    res = categories_mock.getCategoryById(str(category_id))
    return res


@categories_api.route('/categories/<uuid:category_id>', methods=['PATCH'])
